...
../tools/.imports/dvm/src/dvm.py cpel uvmt_misc_st
../tools/.imports/dvm/src/dvm.py sim uvmt_misc_st -t smoke -s 1

# 3. Gather sim results
../tools/.imports/dvm/src/dvm.py results uvmt_misc_st misc
