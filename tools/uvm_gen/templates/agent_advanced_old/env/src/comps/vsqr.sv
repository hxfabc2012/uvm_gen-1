...
/**
 * Component on which all {{ name_proper }} UVM Agent Self-Test Environment virtual sequences are run.
 */
...
{% if symmetric %}
   /// @defgroup Components
   /// @{
   uvma_{{ name }}_sqr_c  egress_sequencer ; ///< Sequencer handle for {{ mode_1 }} agent
   uvma_{{ name }}_sqr_c  ingress_sequencer; ///< Sequencer handle for {{ mode_2 }} agent
   /// @}
{% else %}
   /// @defgroup Components
   /// @{
   uvma_{{ name }}_{{ mode_1 }}_sqr_c  {{ mode_1 }}_sequencer; ///< Sequencer handle for {{ mode_1 }} agent
   uvma_{{ name }}_{{ mode_2 }}_sqr_c  {{ mode_2 }}_sequencer; ///< Sequencer handle for {{ mode_2 }} agent
   /// @}
{% endif %}
