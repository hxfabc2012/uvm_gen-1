...
// {{ license }}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This file contains sample code that demonstrates how to add an instance of the {{ name_proper }} UVM Environment
...
class my_env_cfg_c extends uvm_object;
   ...
   rand uvme_{{ name }}_st_cfg_c  {{ name }}_cfg; ///< Handle to {{ name }} environment configuration
   ...
   function new(uvm_component parent=null, string name="my_env");
      ...
      cfg = uvme_{{ name }}_st_cfg_c::type_id::create("{{ name }}_cfg");
   endfunction : new
...
class my_env_cntxt_c extends uvm_object;
   ...
   uvme_{{ name }}_st_cntxt_c  {{ name }}_cntxt; ///< Handle to {{ name }} environment context
   ...
   function new(uvm_component parent=null, string name="my_env");
      super.new(parent, name);
      cntxt = uvme_{{ name }}_st_cntxt_c::type_id::create("{{ name }}_cntxt");
   endfunction : new
...
class my_env_c extends uvm_env;
   ...
   uvme_{{ name }}_st_env_c  {{ name }}_env; ///< {{ name_proper }} environment instance.
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      if (!cfg) begin
         ...
         uvm_config_db#(uvme_{{ name }}_st_cfg_c  )::set(this, "{{ name }}_env", "cfg"  , cfg  .{{ name }}_cfg  );
         uvm_config_db#(uvme_{{ name }}_st_cntxt_c)::set(this, "{{ name }}_env", "cntxt", cntxt.{{ name }}_cntxt);
         {{ name }}_env = uvme_{{ name }}_st_env_c::type_id::create("{{ name }}_env", this);
         end
      end
