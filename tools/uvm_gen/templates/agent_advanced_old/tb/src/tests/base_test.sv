...
/**
 * Component from which all other {{ name_proper }} UVM Agent Self-Tests must extend.
...
function void uvmt_{{ name }}_st_base_test_c::retrieve_clknrst_gen_vif();
   ...
   if (!uvm_config_db#(virtual uvmt_{{ name }}_st_clknrst_gen_if)::get(this, "", "vif", clknrst_gen_vif)) begin
