...
class uvma_{{ name }}_vsqr_c extends uvm_sequencer #(
   ...
   // Components
   uvma_{{ name }}_mstr_a_sqr_c  mstr_a_sequencer; ///< TODO Describe uvma_{{ name }}_vsqr_c::mstr_a_sequencer
   uvma_{{ name }}_mstr_r_sqr_c  mstr_r_sequencer; ///< TODO Describe uvma_{{ name }}_vsqr_c::mstr_r_sequencer
   uvma_{{ name }}_slv_a_sqr_c   slv_a_sequencer ; ///< TODO Describe uvma_{{ name }}_vsqr_c::slv_a_sequencer 
   uvma_{{ name }}_slv_r_sqr_c   slv_r_sequencer ; ///< TODO Describe uvma_{{ name }}_vsqr_c::slv_r_sequencer 
   
   // TLM
   uvm_seq_item_pull_port #(uvm_sequence_item        )  upstream_sqr_port    ; ///< TODO Describe uvma_{{ name }}_vsqr_c::upstream_sqr_port
   uvm_analysis_port      #(uvma_{{ name }}_mon_trn_c       )  mon_trn_ap           ; ///< TODO Describe uvma_{{ name }}_vswr_c::mon_trn_ap           
   ...
   uvm_tlm_analysis_fifo  #(uvma_{{ name }}_mstr_r_mon_trn_c)  mstr_r_mon_trn_fifo  ; ///< TODO Describe uvma_{{ name }}_vswr_c::mstr_r_mon_trn_fifo  
   uvm_tlm_analysis_fifo  #(uvma_{{ name }}_slv_a_mon_trn_c )  slv_a_mon_trn_fifo   ; ///< TODO Describe uvma_{{ name }}_vswr_c::slv_a_mon_trn_fifo   
   uvm_tlm_analysis_fifo  #(uvma_{{ name }}_slv_r_mon_trn_c )  slv_r_mon_trn_fifo   ; ///< TODO Describe uvma_{{ name }}_vswr_c::slv_r_mon_trn_fifo   
   ...
   uvm_analysis_export    #(uvma_{{ name }}_mstr_r_mon_trn_c)  mstr_r_mon_trn_export; ///< TODO Describe uvma_{{ name }}_vswr_c::mstr_r_mon_trn_export
   ...
   uvm_analysis_export    #(uvma_{{ name }}_slv_r_mon_trn_c )  slv_r_mon_trn_export ; ///< TODO Describe uvma_{{ name }}_vswr_c::slv_r_mon_trn_export 
...
function void uvma_{{ name }}_vsqr_c::build_phase(uvm_phase phase);
   ...
   mstr_r_sequencer = uvma_{{ name }}_mstr_r_sqr_c::type_id::create("mstr_r_sequencer", this);
   slv_a_sequencer  = uvma_{{ name }}_slv_a_sqr_c ::type_id::create("slv_a_sequencer" , this);
   slv_r_sequencer  = uvma_{{ name }}_slv_r_sqr_c ::type_id::create("slv_r_sequencer" , this);
