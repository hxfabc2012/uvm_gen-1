...
// ${license}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This file contains sample code that demonstrates how to add an instance of the ${name_normal_case} UVM Agent to a
...
class my_env_cfg_c extends uvm_object;
   ...
   rand uvma_${name}_cfg_c  ${name}_cfg; ///< Handle to ${name} agent configuration
...
class my_env_cntxt_c extends uvm_object;
   ...
   uvma_${name}_cntxt_c  ${name}_cntxt; ///< Handle to ${name} agent context
   ...
   function new(uvm_component parent=null, string name="my_env");
      super.new(parent, name);
      cntxt = uvma_${name}_cntxt_c::type_id::create("${name}_cntxt");
   endfunction : new
...
class my_env_c extends uvm_env;
   ...
   uvma_${name}_agent_c  ${name}_agent; ///< ${name_normal_case} agent instance.
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      if (!cfg) begin
         ...
         uvm_config_db#(uvma_${name}_cntxt_c)::set(this, "${name}_agent", "cntxt", cntxt.${name}_cntxt);
